...
<head>
    ...
    <title>Big Brew — Coffee & Eatery | Roasting</title>

    <meta name="title" content="Big Brew — Coffee & Eatery | Roasting">
...
<body>
    ...
    <nav class="navbar navbar-light bg-white d-block d-sm-block d-md-block d-lg-none py-3 border-bottom">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="#">☕️ Big Brew</a>
    ...
    <nav class="py-1 bg-white border-bottom d-none d-sm-none d-md-none d-lg-block text-grey">
        <div class="container d-flex flex-wrap fs-15">
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a href="https://wa.me/+6283809384238" class="nav-link link-dark text-grey px-2" target="_blank">
                        +6283809384238</a>
                </li>
                <li class="nav-item">
                    <a href="https://wa.me/+6282180195431" target="_blank"
                        class="nav-link link-dark text-grey px-2">+6282180195431</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <header class="py-3 mb-4 border-bottom d-none d-sm-none d-md-none d-lg-block bg-white sticky-top">
        <div class="container d-flex flex-wrap justify-content-center">
            <a href="/" class="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto text-dark text-decoration-none">
                <span class="fs-3 fw-bold">☕️ Big Brew</span>
            </a>
            <button class="btn btn-warning text-white me-2 px-5 fw-500"
                onclick="location.href='http://127.0.0.1:8000/reservation/step-one'" type="button"> <i
                    class="fas fa-calendar-plus"></i> &nbsp; &nbsp; Buat
        ...
        <div class="container">
            <div class="row text-white">
                <div class="col-md-6 border-end">
                    <h4 class="fw-bold">☕️ Big Brew — Coffee & Eatery</h4>
                    <p class="">
                        Big Brew adalah restoran yang menyediakan berbagai macam kategori makanan mulai dari minuman,
                        dessert dan lain lain dengan harga kaki lima namun rasanya bintang lima. Outlet kita selalu
                        rame, jadi jangan lupa reservasi ya!
                    </p>
                    <small class="d-block mb-3">
                        &copy; 2025 Big Grew — Made with laravel 9.4.1 and bootstrap 5.2.0
                    </small>
                </div>
