    ...
    <section class="my-5">
        <div class="container">
            <div class="row my-4 mx-1">
                ...
                rounded-3
              ">
                    <small>RESERVASI BIG BREW</small>
                    <h1 class="fw-bold">Reservasi tempat meja di Big Brew</h1>
                    <p>Isi form dibawah dengan benar untuk reservasi di Big Brew</p>
                    <hr />
                    <form method="POST" action="{{ route('reservations.store.step.one') }}" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" id="res_date" name="res_date"
                                ...
                                class="form-control" />
                            <span class="mt-1 fs-12">Dimohon untuk memilih jam 10:00-22:00.</span>
                            @error('res_date')
                                <p class="register_text_error">{{ $message }}</p>
                            @enderror
                        </div>
